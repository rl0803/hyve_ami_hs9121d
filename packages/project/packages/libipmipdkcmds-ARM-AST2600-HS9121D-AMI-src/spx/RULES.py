...
#-------------------------------------------------------------------------------------------------------
# Rules to create libipmipdkcmds package
def build_package_libipmipdkcmds():
	return Py_PackSPX("./",PrjVars["BUILD"]+"/"+PrjVars["PACKAGE"]+"/data/libipmipdkcmds.so."+PrjVars["PKG_MAJOR"]+"."+PrjVars["PKG_MINOR"]+"."+PrjVars["PKG_AUX"])
