...
CFG_FILE_PLATFORM="hs9121d.config"
EMMC_CFG_FILE_PLATFORM="hs9121d-emmc.config"
DTS_FILE_PLATFORM="hs9121d.dts"
...
def build_source():
	...
	SrcFile="%s/%s/data/%s"%(PrjVars["BUILD"],PrjVars["PACKAGE"],CFG_FILE_PLATFORM)
	if "CONFIG_SPX_FEATURE_HW_EMMC_BOOT" in PrjVars:
		SrcFile="%s/%s/data/%s"%(PrjVars["BUILD"],PrjVars["PACKAGE"],EMMC_CFG_FILE_PLATFORM)
	...
	SrcFile="%s/%s/data/%s"%(PrjVars["BUILD"],PrjVars["PACKAGE"],DTS_FILE_PLATFORM)
