...
*/
//#define PLATFORM_TMP_UNSUPPORTED_SENSORS	DECL_SENSORS(_SENSOR(SENSOR_NUM_FP_TEMP), _SENSOR(SENSOR_NUM_PDB0_TEMP), _SENSOR(END_SKU_SENSOR_LIST))
#define PLATFORM_TMP_UNSUPPORTED_SENSORS	DECL_SENSORS(_SENSOR(SENSOR_NUM_FP_TEMP), _SENSOR(END_SKU_SENSOR_LIST))
