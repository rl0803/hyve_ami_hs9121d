...
CFG_FILE="HS9121D.config"
DTS_FILE="HS9121D.dts"
...
def build_source():
	...
	# Copy projdef.h to DTS directory
	retval = Py_CopyFile(PrjVars["SPXINC"]+"/projdef.h", PrjVars["KERNEL_SRC"]+"/linux/arch/arm/boot/dts/")
	if retval != 0:
		return retval
